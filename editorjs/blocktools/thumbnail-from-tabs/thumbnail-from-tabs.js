 ...
 */
//class ThumbnailFromTabs { // use this line for local testing
export class ThumbnailFromTabs {
  /**
  ...
  render(){
    ...
    var array = ["https://cdn.pixabay.com/photo/2017/09/01/21/53/blue-2705642_1280.jpg","https://cdn.pixabay.com/photo/2017/09/01/21/53/blue-2705642_1280.jpg"];
    ...
    input.addEventListener('change', (event) => {
      console.log("got change", event, event.target.value)
  ...
  _createImage(url, captionText){
    ...
    console.log("hier", url, captionText)
